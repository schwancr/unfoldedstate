...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      parameter(ns = 92) ! set this to the numbers of experimental data points
...
c     INPUT YOUR DATA HERE!
      open(unit=10,file='msg_a62k_x8.dat',status='old')
      rewind 10
      read(10,*)
